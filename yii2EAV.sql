...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 10 2018 г., 17:19
...
(79, 13, 1, 'Text', 'c79', 'Текст', NULL, NULL, '', 1, 0),
(80, 13, 2, 'DropDownList', 'c80', 'DropDownList', NULL, NULL, '', 1, 0),
(81, 13, 4, 'EncodedTextInput', 'c81', 'EncodedTextInput', NULL, NULL, '', 1, 0),
(90, 13, 6, 'Area', 'с82', 'Textarea', 'NULL', 0, '', 0, NULL),
(91, 13, 7, 'Num', 'с83', 'Номер', 'NULL', 0, '', 0, NULL);
...
(385, 77, 'резервный', 1, 0),
(386, 77, 'ежедневный', 0, 0),
(387, 77, 'постоянный', 0, 0),
(388, 78, 'A', 1, 0),
(389, 78, 'C', 0, 0),
(390, 80, 'Опция 1', 1, 0),
(391, 80, 'Опция 2', 0, 0);
...
--
ALTER TABLE `product`
  MODIFY `id` int(254) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
